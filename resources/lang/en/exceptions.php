...
return [
	...
	"notecategories" => [
	"already_exists" => "That Note Category already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Note Category. Please try again.",
	"delete_error" => "There was a problem deleting this Note Category. Please try again.",
	"not_found" => "That Note Category does not exist.",
	"update_error" => "There was a problem updating this Note Category. Please try again.",
	],
	"blogtags" => [
	...
	"data" => [
	"already_exists" => "That Data already exists. Please choose a different name.",

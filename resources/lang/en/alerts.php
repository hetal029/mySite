...
return [
	...
	"notecategories" => [
	"created" => "The Note Category was successfully created.",
	"deleted" => "The Note Category was successfully deleted.",
	"updated" => "The Note Category was successfully updated.",
	],
	"blogtags" => [
